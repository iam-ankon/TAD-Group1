...
const AddEmployee = () => {
    ...
    useEffect(() => {
        const fetchCompanies = async () => {
            try {
                const response = await axios.get("https://tadbackend-5456.onrender.com/api/hrms/api/tad_groups/");
        ...
        const fetchCustomers = async () => {
            try {
                const response = await axios.get("https://tadbackend-5456.onrender.com/api/hrms/api/customers/");
