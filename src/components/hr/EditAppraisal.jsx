...
const EditAppraisal = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://192.168.0.163:8000/api/hrms/api/performanse_appraisals/${id}/`)
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.put(`http://192.168.0.163:8000/api/hrms/api/performanse_appraisals/${id}/`, formData);
