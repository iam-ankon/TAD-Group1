...
const EditAppraisal = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://tad-group.onrender.com/api/hrms/api/performanse_appraisals/${id}/`)
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.put(`https://tad-group.onrender.com/api/hrms/api/performanse_appraisals/${id}/`, formData);
