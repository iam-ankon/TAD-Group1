...
const EditAppraisal = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://tadbackend-5456.onrender.com/api/hrms/api/performanse_appraisals/${id}/`)
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.put(`https://tadbackend-5456.onrender.com/api/hrms/api/performanse_appraisals/${id}/`, formData);
