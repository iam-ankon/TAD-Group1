...
import {
  FaEdit, FaArrowLeft, FaPrint, FaUserTie,
  FaBuilding, FaMoneyBillWave, FaEnvelope, FaPhone,
    ...
    const fetchCustomerNames = async () => {
      if (employee?.customer && employee.customer.length > 0) {
        ...
        for (const customerId of employee.customer) {
          try {
            const response = await axios.get(`https://tadbackend-5456.onrender.com/api/hrms/api/customers/${customerId}/`);
          ...
          <div class="print-container">
            ...
            <div class="detail-sections">
              <div class="detail-section">
                ...
                <div class="detail-row"><span>Company:</span><span>${employee.company_name || employee.company}</span></div>
                <div class="detail-row"><span>Job Title:</span><span>${employee.job_title}</span></div>
                <div class="detail-row"><span>Salary:</span><span>৳${employee.salary}</span></div>
                <div class="detail-row"><span>Joining Date:</span><span>${employee.joining_date}</span></div>
                <div class="detail-row"><span>Reporting Leader:</span><span>${employee.reporting_leader}</span></div>
                <div class="detail-row"><span>Customers:</span><span>${customerNames.length > 0 ? customerNames.join(", ") : "N/A"}</span></div>
              </div>

              <div class="detail-section">
                <h4>Contact Information</h4>
                <div class="detail-row"><span>Email:</span><span>${employee.email}</span></div>
                <div class="detail-row"><span>Personal Phone:</span><span>${employee.personal_phone}</span></div>
                <div class="detail-row"><span>Office Phone:</span><span>${employee.office_phone}</span></div>
                <div class="detail-row"><span>Reference Phone:</span><span>${employee.reference_phone || "N/A"}</span></div>
              </div>

              <div class="detail-section">
                <h4>Address Information</h4>
                <div class="detail-row"><span>Mailing Address:</span><span>${employee.mail_address}</span></div>
                <div class="detail-row"><span>Permanent Address:</span><span>${employee.permanent_address}</span></div>
              </div>

              <div class="detail-section">
                <h4>Personal Information</h4>
                <div class="detail-row"><span>Date of Birth:</span><span>${employee.date_of_birth}</span></div>
                <div class="detail-row"><span>Special Skills:</span><span>${employee.special_skills || "N/A"}</span></div>
                <div class="detail-row"><span>Remarks:</span><span>${employee.remarks || "N/A"}</span></div>
              </div>
            </div>
          </div>
        </body>
