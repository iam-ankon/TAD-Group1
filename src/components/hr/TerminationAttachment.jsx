...
const TerminationAttachment = () => {
  ...
  const fetchAttachments = async () => {
    try {
      const response = await axios.get(
        `https://tadbackend-5456.onrender.com/api/hrms/api/termination_attachment/?employee_id=${id}`
      );
  ...
  const handleUpload = async () => {
    ...
    try {
      await axios.post(
        "https://tadbackend-5456.onrender.com/api/hrms/api/termination_attachment/",
        formData,
        {
