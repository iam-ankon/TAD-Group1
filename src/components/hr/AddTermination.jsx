...
const AddTermination = () => {
    ...
    useEffect(() => {
        axios.get("http://192.168.0.163:8000/api/hrms/api/tad_groups/")  // Replace this URL with your API for TAD group companies
            .then((response) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post("http://192.168.0.163:8000/api/hrms/api/employee_termination/", formData)
            .then(() => {
