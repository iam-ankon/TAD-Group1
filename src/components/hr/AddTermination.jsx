...
const AddTermination = () => {
    ...
    useEffect(() => {
        axios.get("https://tad-group.onrender.com/api/hrms/api/tad_groups/")  // Replace this URL with your API for TAD group companies
            .then((response) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post("https://tad-group.onrender.com/api/hrms/api/employee_termination/", formData)
            .then(() => {
