...
const AddTermination = () => {
    ...
    useEffect(() => {
        axios.get("https://tadbackend-5456.onrender.com/api/hrms/api/tad_groups/")  // Replace this URL with your API for TAD group companies
            .then((response) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post("https://tadbackend-5456.onrender.com/api/hrms/api/employee_termination/", formData)
            .then(() => {
