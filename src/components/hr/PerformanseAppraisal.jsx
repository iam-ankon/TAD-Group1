...
const PerformanseAppraisal = () => {
  ...
  const fetchAppraisals = async () => {
    try {
      const response = await axios.get("https://tadbackend-5456.onrender.com/api/hrms/api/performanse_appraisals/");
  ...
  const handleDelete = async (id, event) => {
    ...
    if (window.confirm("Are you sure you want to delete this appraisal?")) {
      try {
        await axios.delete(`https://tadbackend-5456.onrender.com/api/hrms/api/performanse_appraisals/${id}/`);
