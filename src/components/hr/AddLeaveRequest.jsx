...
const AddLeaveRequest = () => {
  ...
  useEffect(() => {
    ...
    Promise.all([
      axios.get('https://tadbackend-5456.onrender.com/api/hrms/api/employees/'),
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://tadbackend-5456.onrender.com/api/hrms/api/employee_leaves/', updatedLeave)
      .then(() => {
